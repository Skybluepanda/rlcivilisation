...
export default function WorldContent() {
    ...
    const [selectedTerritory, setSelectedTerritory] = useState(
        territoryGrid[player[0]][player[1]],
    );
        ...
        <MantineProvider>
            <Group justify="flex-start">
                ...
                <Box>
                    ...
                    <Text>
                        Coordinates: {selectedTerritory.coordinates[0]},{' '}
                        {selectedTerritory.coordinates[1]}
                        <br></br>
                        Earth:{' '}
                        {selectedTerritory.explore == 0
                            ? 'Unexplored'
                            : selectedTerritory.earth}
                        <br></br>
                        Fire:{' '}
                        {selectedTerritory.explore == 0
                            ? 'Unexplored'
                            : selectedTerritory.fire}
                        <br></br>
                        Water:{' '}
                        {selectedTerritory.explore == 0
                            ? 'Unexplored'
                            : selectedTerritory.water}
                        <br></br>
                        Nature:{' '}
                        {selectedTerritory.explore == 0
                            ? 'Unexplored'
                            : selectedTerritory.nature}
                        <br></br>
                    </Text>
                </Box>
            </Group>
